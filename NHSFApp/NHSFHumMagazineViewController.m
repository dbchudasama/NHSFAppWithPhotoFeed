//
//  NHSFHumMagazineViewController.m
//  NHSFApp
//
...
#import "NHSFHumMagazineViewController.h"

@interface NHSFHumMagazineViewController ()

@end

@implementation NHSFHumMagazineViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://drive.google.com/folderview?id=0B6OBRdGlEgKWVmJDUHY3Z014Vkk&usp=sharing&tid=0BzyMQbHGDsGbNWQ4bVZpOE1ZZWs#grid"];
