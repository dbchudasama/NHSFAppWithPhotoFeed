//
//  NHSFMustKnowMantrasViewController.m
//  NHSFApp
//
...
#import "NHSFMustKnowMantrasViewController.h"

@interface NHSFMustKnowMantrasViewController ()

@end

@implementation NHSFMustKnowMantrasViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Must Know Mantras" ofType:@"pdf"];
