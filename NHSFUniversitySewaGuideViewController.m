//
//  NHSFUniversitySewaGuideViewController.m
//  NHSFApp
//
//  Created by Divyesh B Chudasama on 17/07/2014.
//  Copyright (c) 2014 DivyeshBC. All rights reserved.
//

#import "NHSFUniversitySewaGuideViewController.h"

@interface NHSFUniversitySewaGuideViewController ()

@end

@implementation NHSFUniversitySewaGuideViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Sewa at Universities" ofType:@"pdf"];
