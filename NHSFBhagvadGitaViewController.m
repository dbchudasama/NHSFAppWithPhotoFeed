//
//  NHSFBhagvadGitaViewController.m
//  NHSFApp
//
...
#import "NHSFBhagvadGitaViewController.h"

@interface NHSFBhagvadGitaViewController ()

@end

@implementation NHSFBhagvadGitaViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Bhagavad Gita" ofType:@"pdf"];
