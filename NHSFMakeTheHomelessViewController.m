//
//  NHSFMakeTheHomelessViewController.m
//  NHSFApp
//
...
#import "NHSFMakeTheHomelessViewController.h"

@interface NHSFMakeTheHomelessViewController ()

@end

@implementation NHSFMakeTheHomelessViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=GoGtaXt5f1w&index=4&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId"];
