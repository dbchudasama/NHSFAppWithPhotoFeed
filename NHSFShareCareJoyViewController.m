//
//  NHSFShareCareJoyViewController.m
//  NHSFApp
//
...
#import "NHSFShareCareJoyViewController.h"

@interface NHSFShareCareJoyViewController ()

@end

@implementation NHSFShareCareJoyViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=HkuKHwetV6Q&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId&index=5"];
