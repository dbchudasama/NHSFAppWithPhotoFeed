//
//  NHSFEventsOnAPlateViewController.m
//  NHSFApp
//
...
#import "NHSFEventsOnAPlateViewController.h"

@interface NHSFEventsOnAPlateViewController ()

@end

@implementation NHSFEventsOnAPlateViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://drive.google.com/folderview?id=0BzyMQbHGDsGbdVFaQ04zTy1KVGs&usp=sharing&tid=0BzyMQbHGDsGbMmZSMFdpeDFuNkU"];
