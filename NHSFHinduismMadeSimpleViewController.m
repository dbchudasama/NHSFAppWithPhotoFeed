//
//  NHSFHinduismMadeSimpleViewController.m
//  NHSFApp
//
//  Created by Divyesh B Chudasama on 16/07/2014.
//  Copyright (c) 2014 DivyeshBC. All rights reserved.
//

#import "NHSFHinduismMadeSimpleViewController.h"

@interface NHSFHinduismMadeSimpleViewController ()

@end

@implementation NHSFHinduismMadeSimpleViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://drive.google.com/folderview?id=0B6OBRdGlEgKWWGo0d21aWTVmVU0&usp=sharing&tid=0BzyMQbHGDsGbNWQ4bVZpOE1ZZWs#grid"];
