//
//  NHSFSangeetOfTheSoulViewController.m
//  NHSFApp
//
...
#import "NHSFSangeetOfTheSoulViewController.h"

@interface NHSFSangeetOfTheSoulViewController ()

@end

@implementation NHSFSangeetOfTheSoulViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Sangeet of the Soul" ofType:@"pdf"];
