//
//  NHSFRachelBeckwithViewController.m
//  NHSFApp
//
...
#import "NHSFRachelBeckwithViewController.h"

@interface NHSFRachelBeckwithViewController ()

@end

@implementation NHSFRachelBeckwithViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=nC_vXAF-pBM&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId&index=8"];
