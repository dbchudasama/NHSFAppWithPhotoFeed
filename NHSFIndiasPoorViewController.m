//
//  NHSFIndiasPoorViewController.m
//  NHSFApp
//
...
#import "NHSFIndiasPoorViewController.h"

@interface NHSFIndiasPoorViewController ()

@end

@implementation NHSFIndiasPoorViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=LcJ1iFPKm00&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId&index=7"];
