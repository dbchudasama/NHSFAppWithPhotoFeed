//
//  NHSFHanumanChalisaViewController.m
//  NHSFApp
//
...
#import "NHSFHanumanChalisaViewController.h"

@interface NHSFHanumanChalisaViewController ()

@end

@implementation NHSFHanumanChalisaViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Hanuman Chalisa Colour" ofType:@"pdf"];
