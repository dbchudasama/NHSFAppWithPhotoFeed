//
//  NHSFOmJaiJagdishViewController.m
//  NHSFApp
//
...
#import "NHSFOmJaiJagdishViewController.h"

@interface NHSFOmJaiJagdishViewController ()

@end

@implementation NHSFOmJaiJagdishViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"Om Jai Jagdish Aarti" ofType:@"pdf"];
