//
//  NHSFWaterChangesEverythingViewController.m
//  NHSFApp
//
...
#import "NHSFWaterChangesEverythingViewController.h"

@interface NHSFWaterChangesEverythingViewController ()

@end

@implementation NHSFWaterChangesEverythingViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=BCHhwxvQqxg&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId"];
