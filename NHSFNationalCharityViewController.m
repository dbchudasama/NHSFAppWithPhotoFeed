//
//  NHSFNationalCharityViewController.m
//  NHSFApp
//
...
#import "NHSFNationalCharityViewController.h"

@interface NHSFNationalCharityViewController ()

@end

@implementation NHSFNationalCharityViewController
...
- (void)viewDidLoad
{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"NHSF (UK) National Charity" ofType:@"pdf"];
