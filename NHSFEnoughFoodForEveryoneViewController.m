//
//  NHSFEnoughFoodForEveryoneViewController.m
//  NHSFApp
//
...
#import "NHSFEnoughFoodForEveryoneViewController.h"

@interface NHSFEnoughFoodForEveryoneViewController ()

@end

@implementation NHSFEnoughFoodForEveryoneViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.youtube.com/watch?v=Xi38ZtG4NhM&index=2&list=PL9xw-8HRkwNx76bdH0GBgQ5AiJaFqNxId"];
